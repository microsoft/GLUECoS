...
from transformers import (
    ...
    XLMRobertaForSequenceClassification, XLMRobertaTokenizer, AdamW, Adafactor, get_linear_schedule_with_warmup)
...
def main():
    ...
    parser.add_argument("--scale_parameter", default=0.5, type=float,
                    help="the scale parameter for Adafactor optimizer")
    parser.add_argument("--decay_rate", default=None, type=float,
                        help="the weight decay rate for Adafactor optimizer")
    parser.add_argument("--beta1", default=None, type=float,
                        help="the beta1 value for Adafactor optimizer")
    parser.add_argument("--factored", action="store_true",
                        help="whether to use factored second moments in Adafactor optimizer")
    parser.add_argument("--rectify", action="store_true",
                        help="whether to rectify the update direction in Adafactor optimizer")
